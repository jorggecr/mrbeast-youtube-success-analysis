...
def process_video(vid_id):
    ...
    try:
        with yt_dlp.YoutubeDL(full_opts) as ydl:
            ...
            publish_date = info.get('upload_date', 'N/A')  # Publish date (YYYYMMDD)
...
# Save CSV
output_path = "data/raw/videos_mrbeast_with_duration.csv"
...
print(
    ...
    "SUMMARY REPORT\n"
    + "=" * 60 + "\n"
    f"Output file           : videos_mrbeast_with_duration.csv\n"
